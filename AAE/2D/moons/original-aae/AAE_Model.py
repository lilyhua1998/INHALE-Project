...
class AAE():
    def __init__(self, Z, n_features, batch_size, GANorWGAN, nodes, var):
        ...
        self.optimizer1 = tf.optimizers.Nadam(self.lr_start, beta_1=0.5, beta_2=0.9) #1e-3
    ...
    def train(self, Z, batch_size, dataset, epochs, scaler, X_train_scaled, scaled, X_train, y_train ):
        ...
        self.encoder.save('./content/encoder_'+str(epochs) )
        self.decoder.save('./content/decoder_'+str(epochs))
        self.discriminator.save('./content/discriminator_'+str(epochs) )
        print('save model')
